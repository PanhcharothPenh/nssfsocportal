    ...
    if (activeCategory === 'system_change') {
      return `
        ...
        <body>
          ...
          <table class="header-table">
            <tr>
              <td style="width: 48%; vertical-align: top;">
                <img src="/nssf_logo.png" class="logo" style="width: 82px; height: auto; display: block; margin-bottom: 4px;" alt="NSSF Logo" onerror="this.onerror=null; this.src='/Nssf_Resize_Logo.png';" />
          ...
          <!-- Signature Block -->
          <div style="float: right; margin-top: 4px; font-size: 11.5px; white-space: nowrap; display: flex; flex-direction: column; align-items: center;">
